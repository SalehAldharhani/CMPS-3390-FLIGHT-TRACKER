...
function conditionType(condition = '') {
  ...
  if (c.includes('cloud') || c.includes('partly') || c.includes('scattered')) return 'cloudy';
  return 'clear';
}
  ...
  switch (type) {
    case 'clear': return (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M32 6v8M32 50v8M6 32h8M50 32h8M14.1 14.1l5.7 5.7M44.2 44.2l5.7 5.7M49.9 14.1l-5.7 5.7M19.8 44.2l-5.7 5.7"
              stroke="currentColor" strokeWidth="3.5" strokeLinecap="round"/>
      </svg>
    );
    case 'cloudy': return (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M50 44H18a12 12 0 010-24 1 1 0 011 .1A16 16 0 0150 32a12 12 0 010 12z" fill="currentColor"/>
        <path d="M18 32a8 8 0 010-16 1 1 0 011 .1A11 11 0 0130 24" stroke="currentColor" strokeWidth="2" strokeLinecap="round" opacity="0.5"/>
      </svg>
    );
    case 'overcast': return (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M52 46H16a13 13 0 010-26 1 1 0 011 .1A17 17 0 0152 34a13 13 0 010 12z" fill="currentColor"/>
        <path d="M8 26h4M52 14l-3 3M20 10l2 3" stroke="currentColor" strokeWidth="3" strokeLinecap="round" opacity="0.4"/>
      </svg>
    );
    case 'rain': return (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M50 36H18a12 12 0 010-24 1 1 0 011 .1A16 16 0 0150 24a12 12 0 010 12z" fill="currentColor"/>
        <path d="M20 46l-4 12M30 46l-4 12M40 46l-4 12M50 46l-4 12"
              stroke="currentColor" strokeWidth="3" strokeLinecap="round"/>
      </svg>
    );
    case 'storm': return (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M50 34H18a12 12 0 010-24 1 1 0 011 .1A16 16 0 0150 22a12 12 0 010 12z" fill="currentColor"/>
        <path d="M36 38l-10 14h10l-8 12" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    );
    case 'snow': return (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M50 36H18a12 12 0 010-24 1 1 0 011 .1A16 16 0 0150 24a12 12 0 010 12z" fill="currentColor"/>
        <path d="M20 52v-8M20 48h4M20 48h-4M32 52v-8M32 48h4M32 48h-4M44 52v-8M44 48h4M44 48h-4"
              stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
      </svg>
    );
    case 'fog': return (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M8 16h48M8 26h48M8 36h36M8 46h40" stroke="currentColor" strokeWidth="4.5" strokeLinecap="round"/>
      </svg>
    );
    default: return null;
  }
...
function WeatherCard({ title, weather }) {
  ...
  const type   = conditionType(weather.condition);
  const bgClass = BG_CLASS[type];
  return (
    <article className={`ft-weather__card ft-weather__card--${weather.flightImpact} ${bgClass}`}>
